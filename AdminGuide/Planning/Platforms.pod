...
grained use of platform instances.  By default, EFS no longer requireds
...
mount for /efs/dist, the /.efs/dist mount either instance or platform
specific.  For example, if you only define platforms in your domain,
the mounts typically look something like:
